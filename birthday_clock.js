   ...
   let seconds = Math.floor((distance % (1000 * 60)) / 1000);
    ...
    if (distance < 0) {
       ...
       let dtval = 6.0
        ...
        $('#lol').after('<div id="start-button" style="margin-top: 10px"><button id="start-button" style="color: red; background-color:#ffffff42; width: 20vw; height:8vh; font-size: 20px;  font-family: "Monsterrat", sans-serif; " onClick="gameInit()">Start the MaxiKing game</button></div>')
